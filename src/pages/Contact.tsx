        ...
        <div className="container px-4 md:px-6">
          ...
          <div className="grid md:grid-cols-3 gap-6 max-w-4xl mx-auto">
            <div className="bg-background border border-border rounded-lg p-8 text-center hover:shadow-lg transition-shadow">
              ...
              <Button variant="outline" className="rounded-full border-primary text-primary hover:bg-primary hover:text-primary-foreground px-6">Submit Request</Button>
            </div>
      ...
      <section className="py-16 md:py-24">
        <div className="container px-4 md:px-6">
          <div className="text-center">
            ...
            <Button className="bg-primary text-primary-foreground hover:bg-primary/90 px-10 py-6 text-base rounded-md">Try it free now</Button>
          </div>
        </div>
      </section>
