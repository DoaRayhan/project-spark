...
const Pricing = () => {
  ...
  const plans = [
    ...
    },
    {
      ...
      description: "Organize across all apps by hand",
      features: ["Unlimited product updates", "5GB Cloud storage", "Email and community support", "Personal help center", "Access to new features"],
      highlighted: true,
    },
    {
      name: "PREMIUM",
      ...
      description: "Organize across all apps by hand",
      features: ["Unlimited product updates", "Unlimited Cloud storage", "Priority email support", "Personal help center", "Access to new features", "24/7 Phone support"],
      highlighted: false,
    },
  ];
        ...
        <div className="container px-4 md:px-6">
          <div className="text-center mb-12">
            ...
            <div className="flex items-center justify-center gap-4">
              ...
              <button
                ...
                className={`relative w-12 h-6 rounded-full transition-colors ${isYearly ? 'bg-primary' : 'bg-muted-foreground/30'}`}
              >
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            {plans.map((plan, index) => (
              <div 
                key={index} 
                className={`rounded-lg p-8 text-center ${plan.highlighted ? 'bg-foreground text-background scale-105' : 'bg-background border'}`}
              >
                ...
                <Button 
                  className={`w-full ${plan.highlighted ? 'bg-primary text-primary-foreground hover:bg-primary/90' : 'bg-primary text-primary-foreground hover:bg-primary/90'}`}
                >
                  Try for free
                </Button>
              </div>
